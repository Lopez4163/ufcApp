  ...
  return (
    <div className="overlay-container">
      ...
      <div className="overlay-summary-nd-signup">
        ...
        <p className="newsletter-summary">
          Thank you for visiting and checking out what i do on my time off. Get
          fighter updates and possibly more!{" "}
        </p>
        {emailSent ? (
          <h3 className="email-sent-message">Thanks!!</h3>
        ) : (
          <form className="overlay-signup-form" ref={form} onSubmit={sendEmail}>
            <input
              className={`user-email-input ${nameError ? "error" : ""}`}
              type="text"
              name="user_name"
              placeholder=" Full Name"
            />
            <input
              className={`user-email-input ${emailError ? "error" : ""}`}
              type="email"
              name="user_email"
              placeholder="Email"
            />
            <input
              className="overlay-user-email-submit"
              type="submit"
              value="Send"
            />
          </form>
