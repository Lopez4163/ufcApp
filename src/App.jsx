  ...
  const filterFighters = (weightClass, gender) => {
    ...
    if (gender) {
      if (weightClass === null) {
        ...
        const flyweightArray = filteredFighters.filter((fighter) =>
          fighter.weightClass.includes("Flyweight"),
        );
        if (gender === "Female") {
          filteredFighters = flyweightArray.filter((fighter) =>
            fighter.weightClass.includes("Women's Flyweight"),
          );
        }
    ...
    <div className="app-container">
      <Navbar
        ...
        onShowLightHeavyWeight={() =>
          filterFighters("Light Heavyweight", gender)
        }
